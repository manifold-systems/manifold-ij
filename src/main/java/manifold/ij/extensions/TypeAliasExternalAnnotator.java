...
public class TypeAliasExternalAnnotator extends ExternalAnnotator<PsiFile, TypeAliasExternalAnnotator.Info>
{
  @Nullable
  @Override
  ...
  public Info doAnnotate( PsiFile file )
  {
    ...
    return ApplicationManager.getApplication().runReadAction( (Computable<Info>)() -> {
      ...
      if( module == null || !module.isTypeAliasEnabled() )
      {
        return Info.EMPTY;
      }
  ...
  {
//    TypeAliasMaker.checkTypeAlias( psiClass, info );
//
...
//    }
  ...
  public void apply( @NotNull PsiFile file, Info info, @NotNull AnnotationHolder holder )
  {
    ...
    if( module == null || !module.isTypeAliasEnabled() )
    {
      // type alias not in use in module
      return;
    }
