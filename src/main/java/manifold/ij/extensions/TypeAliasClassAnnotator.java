...
public class TypeAliasClassAnnotator implements Annotator
{
  @Override
...
//    PsiClass psiAliasingClass = findTypeAliasClass( element );
//    if( psiAliasingClass != null )
//    {
...
//    }
  ...
  public static PsiClass findTypeAliasClass( PsiElement element )
  {
...
//      if( modifierList != null && modifierList.findAnnotation( TypeAlias.class.getName() ) != null )
//      {
//        return psiClass;
//      }
//    }
